...
<body>
    <table align={quo}center{quo} border={quo}0{quo} cellpadding={quo}0{quo} cellspacing={quo}0{quo} width={quo}700{quo} style={quo}border-collapse: collapse;{quo}>
        ...
        <tr>
            <td bgcolor={quo}#ffffff{quo} style={quo}padding: 5px 20px 20px 20px;{quo}>
                <table border={quo}0{quo} cellpadding={quo}0{quo} cellspacing={quo}0{quo} width={quo}100%{quo}>
                    ...
                    <tr>
                        <td
                            style={quo}color: #002b15; padding: 20px 0 30px 0; font-family: Arial, sans-serif; font-size: 20px;{quo}>
                            {message}
                        </td>
                    </tr>
                    <tr>
                        <td align={quo}center{quo} style={quo}padding: 10px 0 10px 0;{quo}>
                            <a href={quo}{link}{quo}>
                                <button
        ...
        <tr>
            <td bgcolor={quo}#002b15{quo} style={quo}padding: 20px 20px 20px 20px;{quo}>
                <table border={quo}0{quo} cellpadding={quo}0{quo} cellspacing={quo}0{quo} width={quo}100%{quo}>
                    <tr>
